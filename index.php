	...
	<nav class="navbar  navbar-default navbar-fixed-top navbar-inverse">
        ...
        <div class="dropdown" >
          ...
          <li><a href="Product.php?value=Health%20and%20Cooking"> Health and Cooking </a>   </li>
				...
				<a class="navbar-brand" href="#" style="padding: 0px;"><img class="img-responsive" alt="Brand" src="img/logo.jpg" style="width: 147px;
        margin: 0px;"></a>
        ...
        if(!isset($_SESSION['user']))
          {
            echo'
            <li>
                <button type="button" id="login_button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#login">Login</button>
    ...
    <div id="searchbox" class="container-fluid" style="width: 112%;margin-left: -6%; margin-right: -6%">
        <div>
            ...
            <form role="search" method="POST" action="Result.php">
              <input type="text" class="form-control" name="keyboard" style="width: 75%; margin: 20px 10% 20px 10%;" placeholder="Search for a book , Author or Category" >
              
              <!--<div class="search"> <i class="fa fa-search"></i>
                <input type="text" class="form-control" placeholder="Search for a book , Author or Category">-->
              </form>
    ...
    <span class="sr-only">Next</span>
       ...
       <!-- carousel control -->
        ...
        <div class="col-md-3 col-lg-3" id="offer">
          <a href="Product.php?value=Regional%20Books">
            <img class="img-responsive centre-block"src="img/offer/1.png"></a>
            <a href="Product.php?value=Health%20and%20Cooking">       
              <img class="img-responsive center-block" src="img/offers/2.png"></a>
      ...
      <div class="container-fluid text-center" id="new"> <!-- container fluid--class to create a full width container, that will always span the entire width of the screen (width is always 100%) -->
        <div class="row">
          <div class="col-sm-6 col-md-3 col-lg-3">
            <a href="description.php?ID=NEW-1&category=new">
              <div class="book-block">
                ...
                <img class="book block-centre img-responsive" src="img/new/1.jpg">
                <hr>
                Like A Love Song <br>
                Rs 110 &nbsp
                <span style="text-decoration: line-through;color: #828282;">
                  175
                </span> <!-- span is used to mark up a part of text -->
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <a href="description.php?ID=NEW-2&category=new">
              <div class="book-block">
                <div class="tag">New</div>
                <div class="tag-side"><img src="img/tag.png"></div>
                <img class="book block-centre img-responsive" src="img/new/2.jpg">
                <hr>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <a href="description.php?ID=NEW-3&category=new">
              <div class="book-block">
                <div class="tag">New</div>
                <div class="tag-side"><img src="img/tag.png"></div>
                <img class="book block-centre img-responsive" src="img/new/3.png">
                <hr>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <a href="description.php?ID=NEW-4&category=new">
              <div class="book-block">
                <div class="tag">New</div>
                <div class="tag-side"><img src="img/tag.png"></div>
                <img class="book block-centre img-responsive" src="img/new/4.jpg">
                <hr>
          ...
          <div class="modal-body">
            <form method="post" action="query.php" class="form" role="form">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="5" cols="30" placeholder="Your Query" name="sender" required></textarea>
